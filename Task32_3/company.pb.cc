...
const ::uint32_t TableStruct_company_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    PROTOBUF_FIELD_OFFSET(::Company, _impl_.activity_),
    PROTOBUF_FIELD_OFFSET(::Company, _impl_.external_economic_),
    0,
    3,
    1,
    2,
...
const char descriptor_table_protodef_company_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\rcompany.proto\"`\n\007Company\022\014\n\004name\030\001 \002(\t"
    "\022\n\n\002id\030\002 \002(\005\022\016\n\006adress\030\003 \002(\t\022\020\n\010activity"
    "\030\004 \001(\t\022\031\n\021external_economic\030\005 \001(\010"
};
...
Company::Company(const Company& from)
  ...
  ::memcpy(&_impl_.id_, &from._impl_.id_,
    ...
    reinterpret_cast<char*>(&_impl_.id_)) + sizeof(_impl_.external_economic_));
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::uint8_t>(tag) == 34)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "Company.activity");
          #endif  // !NDEBUG
        } else {
          goto handle_unusual;
        }
...
::uint8_t* Company::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000010u) {
    ...
    target = ::_pbi::WireFormatLite::WriteBoolToArray(
        5, this->_internal_external_economic(), target);
  }
...
void Company::InternalSwap(Company* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Company, _impl_.external_economic_)
      + sizeof(Company::_impl_.external_economic_)
      - PROTOBUF_FIELD_OFFSET(Company, _impl_.id_)>(
